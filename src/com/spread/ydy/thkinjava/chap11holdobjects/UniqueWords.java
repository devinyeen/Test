...
import com.spread.ydy.thkinjava.utils.TextFile;

public class UniqueWords {
    public static void main(String[] args) {
        Set<String> words = new TreeSet<String>(new TextFile("src\\com\\spread\\ydy\\thkinjava\\chap11holdobjects\\SetOperations.java",
                "\\W+"));
